-- Edit the below to be the species you want
local desired_species = { 16, 19, 161, 187 }
--
...
function includes(desired_species, species)
    for j, item in ipairs(desired_species) do
...
while true do
    ...
    if includes(desired_species, species) == false then
